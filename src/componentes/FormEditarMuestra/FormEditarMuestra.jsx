...
function FormEditarMuestra({ idMuestraPantalla }) {
    ...
    useEffect(() => {
        if (!idMuestra.buscando && idMuestra.muestra) {
            setForm({
                nombre: idMuestra.muestra.nombre || "",
                mainScript: idMuestra.muestra.mainScript
                    ? idMuestra.muestra.mainScript.split("/").pop()
                    : "",
                juego_id: idMuestra.muestra.juego_id || "",
            });
            setFotoPreview(idMuestra.muestra.imagen || "");
        }
    }, [idMuestra.buscando, idMuestra.muestra]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await actualizarDemo(idMuestraPantalla, formData);
    ...
    if (idMuestra.buscando) {
        return <p>Cargando datos de la demo...</p>;
    }
    ...
    return (
        <form className="formMuestra" onSubmit={handleSubmit}>
            ...
            <div className="row col-12 infoSecundariaFormMuestra">
                ...
                <div className="col-6">
                    <label htmlFor="carpeta_demo">Carpeta ZIP del juego (opcional):</label>
                    <input
                        type="file"
                        id="carpeta_demo"
                        name="carpeta_demo"
                        ...
                        className="form-control"
                    />
                    <small>Puedes dejarlo vacío si no quieres reemplazar la demo.</small>
                </div>
            </div>
...
export default FormEditarMuestra;
